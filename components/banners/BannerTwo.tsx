...
const BannerTwo = () => {
  ...
  return (
    <section className="bg-linear-to-b bg-gray-600 to-gray-200 dark:bg-gray-900 ">
      <div className="relative max-w-(--breakpoint-xl) mx-auto p-4 md:p-8 overflow-hidden flex flex-col-reverse lg:block">
        ...
        <div className="w-full h-80 lg:h-full lg:absolute lg:inset-y-0 lg:right-0 lg:top-15 lg:w-1/2">
