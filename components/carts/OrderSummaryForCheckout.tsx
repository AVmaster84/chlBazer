  ...
  return (
    <div className="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg">
      ...
      <div className="lg:px-4">
        ...
        <Button className="text-xl mt-6 bg-blue-500 dark:bg-blue-600 text-white py-6 px-12 hover:bg-blue-600 dark:hover:bg-blue-700 focus:outline-hidden rounded-full hover:ring-2">
          Place Order
        </Button>
      </div>
    </div>
