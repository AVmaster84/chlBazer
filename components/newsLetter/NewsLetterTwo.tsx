...
const NewsLetterTwo = () => {
  return (
    <div className="py-16 bg-linear-to-b from-blue-400 to-blue-600 dark:from-gray-700 dark:to-gray-900">
      ...
      <div className="flex justify-center">
        <div className="max-w-lg w-full bg-white dark:bg-gray-800 rounded-lg p-8">
          <form className="flex flex-col sm:flex-row justify-center gap-2 items-center">
            <Input type="email" className="bg-gray-100 dark:bg-gray-700 focus:outline-hidden focus:ring-2 focus:ring-blue-500 rounded-lg py-3 px-4  sm:mr-4 w-full sm:w-72" placeholder="Enter your email address" />
